...
public class SetPlayerData implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try {
            PlayerData playerData = lambdaService.setPlayerData(data);
            String output = gson.toJson(playerData);
